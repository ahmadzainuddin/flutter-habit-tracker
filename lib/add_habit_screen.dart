      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                final newHabit = _habitController.text;
                if (newHabit.isNotEmpty) {
                  setState(() {
                    // Add the new habit to the selectedHabitsMap with the chosen color
                    selectedHabitsMap[newHabit] = selectedColor.value.toRadixString(16);
                    _habitController.clear();
                    selectedColorName = 'Amber'; // Reset to default
                    selectedColor = _habitColors[selectedColorName]!;
                    _saveHabits();
                  });
                  await habit_prefs.HabitPrefs.saveUserAction('Added habit: ' + newHabit);
                }
              },
              child: Text(
                'Add Habit',
                  ...
                  return ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        await habit_prefs.HabitPrefs.saveUserAction('Deleted habit: ' + habitName);
                      },
                    ),
                  );
                }).toList(),
